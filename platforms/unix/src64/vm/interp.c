/* Automatically generated from Squeak on #(27 March 2005 6:13:53 pm) */
...
void byteSwapByteObjectsFromto(sqInt startOop, sqInt stopAddr);
sqInt byteSwapped(sqInt w);
void callExternalPrimitive(void * functionID);
...
void createActualMessageTo(sqInt aClass);
void dispatchFunctionPointer(void * aFunctionPointer);
void dispatchFunctionPointerOnin(sqInt primIdx, void *primTable[]);
...
void dispatchFunctionPointerOnin(sqInt primIdx, void *primTable[]) {
	dispatchFunctionPointer(primTable[primIdx]);
}
